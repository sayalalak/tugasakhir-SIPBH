...
<head>
    ...
    <title>Sistem Informasi Kehilangan Barang</title>
...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>PT. Selamat Lestari Mandiri</strong></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo site_url('login');?>"><i class="glyphicon glyphicon-home"></i> Home</a></li>
                <li><a href="#"><i class="glyphicon glyphicon-user"></i> Daftar Barang</a></li>
                    <ul class="nav nav-second-level">
                        <li> 
                            <a href="<?php echo base_url('login/view_barang'); ?>"><i class="fa fa-users fa-fw"></i> Barang Lelang</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('view_barang'); ?>"><i class="fa fa-desktop fa-fw"></i> Barang Temuan</a>
                        </li>
                    </ul>
                <li><a href="<?php echo site_url('login');?>"><i class="glyphicon glyphicon-home"></i> Form Lapor Kehilangan</a></li>
            </ul>
