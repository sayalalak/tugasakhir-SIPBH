...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>BLU UPTD Trans Semarang</strong></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo site_url('login');?>"><i class="glyphicon glyphicon-home"></i> Home</a></li>
                <li><a href="<?php echo site_url('login/view_barang');?>"><i class="glyphicon glyphicon-user"></i> Data Barang</a></li>
            </ul>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4 align="center">Aplikasi Inventaris Barang</h4><hr class="line-title"> 
