<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('baranglelang'); ?>">Barang</a></li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <a href="<?php echo base_url('barang/edit/'.$row->kode_brg) ?>"><input type="submit" class="btn btn-success btn-xs" name="edit" value="Ubah"></a>
