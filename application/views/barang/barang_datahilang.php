<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('baranghilang'); ?>">Barang Hilang</a></li>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php 
                                $no = 1;
                                foreach($baranghilang->result() as $row) {
                                ?>
                                    <tr>
                                        <td><?php echo $no;?></td>
                                        ...
                                        <td><?php echo $row->tglkejadian;?></td>
                                        <td><?php echo $row->spesifikasibrg;?></td>
                                        <td><?php echo $row->tmptkejadian;?></td>
                                        <td><?php echo $row->kronologi;?></td>
                                        <td><?php echo $row->pelapor;?></td>
                                        <td><?php echo $row->keterangan;?></td>
                                        <td class="text-center">
                                <a href="<?php echo base_url('baranghilang/edit/'.$row->kode_brg) ?>"><input type="submit" class="btn btn-success btn-xs" name="edit" value="Ubah"></a>
                                <a href="#" name="<?php echo $row->nama_brg;?>" class="hapus btn btn-danger btn-xs" kode="<?php echo $row->kode_brg;?>">Hapus</a>
                            </td>
                                    </tr>
                                <?php $no++; } ?>    
                                </tbody>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#konfirmasi").click(function(){
            var kode_brg = $("#idhapus").val();
            
            $.ajax({
                url:"<?php echo site_url('baranghilang/delete');?>",
                type:"POST",
                data:"kode_brg="+kode_brg,
                cache:false,
                success:function(html){
                    location.href="<?php echo site_url('baranghilang/index/delete-success');?>";
                }
            });
        });
    });
