<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('barang/edit/'.$edit['kode_brg']); ?>">Barang</a></li>
        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('barang/update', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="kode_brg" class="form-control" placeholder="Kode Barang" value="<?php echo $edit['kode_brg']; ?>" readonly="readonly">
                    </div>
                </div>
